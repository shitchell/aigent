...
try:
    ...
    from strenum import StrEnum  # type: ignore[assignment]  # Fallback
...
class Dispatcher:
    ...
    def register(
        self, event_name: Union[str, StrEnum], func: Callable[..., Any], priority: int = 0
    ) -> None:
    ...
    def _match_parameters(
        self, func: Callable[..., Any], context: Dict[str, Any]
    ) -> Dict[str, Any]:
...
# Decorator
def handles(
    event_name: Union[str, StrEnum], priority: int = 0
